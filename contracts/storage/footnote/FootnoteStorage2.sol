...
contract FootnoteStorage2 is IStorage {
    ...
    constructor() {
        ...
        footnotes.push("N/a");
        footnotes.push("N/a");
        footnotes.push("[10] See L\\uF3pez, J. \\u2018Economic performance: The Economic Space Protocol.\\u2019 http://economicperformance.manifold.one. See Appendix 1.1 for a brief summary of its current application.\\n [11] Agents are defined more precisely in Chapter 3.2. In this context, they can be thought of as individuals or self-organized groups of individuals under a singular network identity.");
        footnotes.push("N/a");
