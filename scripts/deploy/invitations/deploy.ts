...
async function main() {
  ...
  const invitations: any = await storageHandler.loadStorageDeploymentAddresses(`deployment/${hardhatArguments.network}/invitations/invitations.json`);
  const invitationsHashed: any =  await storageHandler.loadStorageDeploymentAddresses(`deployment/${hardhatArguments.network}/invitations/invitations_hashed.json`);
